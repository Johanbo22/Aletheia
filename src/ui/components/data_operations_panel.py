...
from src.ui.components.data_tabs import CleaningTab, FilteringTab, ColumnsTab, TransformTab, DatetimeTab, SubsetsTab, \
    HistoryTab
...
class DataOperationsPanel(QWidget):
    ...
    def init_ui(self) -> None:
        ...
        self.ops_tabs.addTab(self.subsets_tab, QIcon(get_resource_path("../icons/data_operations/subset.png")),
                             "Subsets")  # TODO Change this icon
