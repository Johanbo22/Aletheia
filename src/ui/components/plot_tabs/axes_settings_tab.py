...
class AxesSettingsTab(QWidget):
    ...
    def _setup_axes_group(self, parent_layout: QVBoxLayout) -> None:
        ...
        self.x_invert_axis_check = ToggleSwitch("Invert X-axis")
        ...
        self.x_top_axis_check = ToggleSwitch("Move X-axis to top")
        ...
        self.x_minor_tick_direction_label = QLabel("X-axis Minor Tick Direction")
        x_layout.addWidget(self.x_minor_tick_direction_label)
        ...
        self.x_minor_tick_width_label = QLabel("X-axis Minor Tick Width")
        x_layout.addWidget(self.x_minor_tick_width_label)
        ...
        self.x_show_minor_ticks_check.toggled.connect(self.x_minor_tick_direction_label.setEnabled)
        self.x_show_minor_ticks_check.toggled.connect(self.x_minor_tick_direction_combo.setEnabled)
        self.x_show_minor_ticks_check.toggled.connect(self.x_minor_tick_width_label.setEnabled)
        self.x_show_minor_ticks_check.toggled.connect(self.x_minor_tick_width_spin.setEnabled)

        x_minor_checked = self.x_show_minor_ticks_check.isChecked()
        self.x_minor_tick_direction_label.setEnabled(x_minor_checked)
        self.x_minor_tick_direction_combo.setEnabled(x_minor_checked)
        self.x_minor_tick_width_label.setEnabled(x_minor_checked)
        self.x_minor_tick_width_spin.setEnabled(x_minor_checked)
        ...
        self.y_invert_axis_check = ToggleSwitch("Invert Y-axis")
        ...
        self.y_minor_tick_direction_label = QLabel("Y-axis Minor Tick Direction")
        y_layout.addWidget(self.y_minor_tick_direction_label)
        ...
        self.y_minor_tick_width_label = QLabel("Y-axis Minor Tick Width:")
        y_layout.addWidget(self.y_minor_tick_width_label)
        ...
        self.y_show_minor_ticks_check.toggled.connect(self.y_minor_tick_direction_label.setEnabled)
        self.y_show_minor_ticks_check.toggled.connect(self.y_minor_tick_direction_combo.setEnabled)
        self.y_show_minor_ticks_check.toggled.connect(self.y_minor_tick_width_label.setEnabled)
        self.y_show_minor_ticks_check.toggled.connect(self.y_minor_tick_width_spin.setEnabled)

        y_minor_checked = self.y_show_minor_ticks_check.isChecked()
        self.y_minor_tick_direction_label.setEnabled(y_minor_checked)
        self.y_minor_tick_direction_combo.setEnabled(y_minor_checked)
        self.y_minor_tick_width_label.setEnabled(y_minor_checked)
        self.y_minor_tick_width_spin.setEnabled(y_minor_checked)
        ...
        self.z_major_tick_direction_combo = QComboBox()
        ...
        self.z_major_tick_width_spin = QDoubleSpinBox()
        ...
        self.z_minor_tick_direction_label = QLabel("Z-axis Minor Tick Direction")
        z_layout.addWidget(self.z_minor_tick_direction_label)
        self.z_minor_tick_direction_combo = QComboBox()
        ...
        self.z_minor_tick_width_label = QLabel("Z-axis Minor Tick Width:")
        z_layout.addWidget(self.z_minor_tick_width_label)
        self.z_minor_tick_width_spin = QDoubleSpinBox()
        ...
        self.z_show_minor_ticks_check.toggled.connect(self.z_minor_tick_direction_label.setEnabled)
        self.z_show_minor_ticks_check.toggled.connect(self.z_minor_tick_direction_combo.setEnabled)
        self.z_show_minor_ticks_check.toggled.connect(self.z_minor_tick_width_label.setEnabled)
        self.z_show_minor_ticks_check.toggled.connect(self.z_minor_tick_width_spin.setEnabled)

        z_minor_checked = self.z_show_minor_ticks_check.isChecked()
        self.z_minor_tick_direction_label.setEnabled(z_minor_checked)
        self.z_minor_tick_direction_combo.setEnabled(z_minor_checked)
        self.z_minor_tick_width_label.setEnabled(z_minor_checked)
        self.z_minor_tick_width_spin.setEnabled(z_minor_checked)
        ...
        self.z_display_units_combo = QComboBox()
    ...
    def _populate_datetime_combo(self, combo: QComboBox) -> None:
