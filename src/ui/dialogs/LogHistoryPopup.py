...
from PyQt6.QtGui import QClipboard, QCloseEvent, QColor, QKeyEvent, QMouseEvent
from PyQt6.QtWidgets import QApplication, QGraphicsColorizeEffect, QGraphicsOpacityEffect, QHBoxLayout, QLabel, \
    QLineEdit, QPushButton, QSizeGrip, QTextEdit, QVBoxLayout, QWidget
