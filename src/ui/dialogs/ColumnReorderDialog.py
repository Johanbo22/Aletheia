import pandas as pd
from PyQt6.QtCore import QEasingCurve, QEvent, QPropertyAnimation, QTimer, QVariantAnimation, Qt
from PyQt6.QtGui import QBrush, QColor, QFont, QIcon, QMouseEvent
from PyQt6.QtWidgets import QApplication, QDialog, QFrame, QGraphicsDropShadowEffect, QHBoxLayout, QHeaderView, QLabel, \
    QLineEdit, QPushButton, QSizePolicy, QTableWidget, QTableWidgetItem, QVBoxLayout
