...
from PyQt6.QtCore import QEvent, QObject, QPoint, QRegularExpression, Qt
from PyQt6.QtGui import QColor, QFont, QKeyEvent, QRegularExpressionValidator
from PyQt6.QtWidgets import QAbstractItemView, QApplication, QComboBox, QDialog, QFormLayout, QFrame, QHBoxLayout, \
    QHeaderView, QLabel, QLineEdit, QMenu, QMessageBox, QPushButton, QSpinBox, QTableWidget, QTableWidgetItem, \
    QVBoxLayout
