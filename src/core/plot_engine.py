...
from src.core.plot_engine_objects.plot_analytics_renderer import PlotAnalyticsRenderer
from src.core.plot_engine_objects.plot_formatter import PlotFormatter
from src.core.plot_engine_objects.plot_layout_manager import PlotLayoutManager
from src.core.plot_engine_objects.plot_metadata import AVAILABLE_PLOTS, PLOT_DESCRIPTIONS
from src.core.plot_engine_objects.plot_table_renderer import PlotTableRenderer
from src.core.plot_engine_objects.secondary_axis_manager import SecondaryAxisManager
from src.core.regression_analyser import RegressionMetrics
...
class PlotEngine:
    ...
    def execute_strategy(self, plot_type: str, plot_tab: "PlotTab", x_col: str, y_cols: List[str], axes_flipped: bool,
        ...
        str]:
        from src.core.plot_strategies.strat_registry import StrategyRegistry
        try:
