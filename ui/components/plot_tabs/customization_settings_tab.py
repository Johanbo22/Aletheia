...
class CustomizationSettingsTab(QWidget):
    ...
    def _setup_pie_page(self) -> None:
        ...
        self.pie_percentage_settings_container = QWidget()
        percent_layout = QVBoxLayout(self.pie_percentage_settings_container)
        percent_layout.setContentsMargins(15, 0, 0, 0)

        percent_layout.addWidget(QLabel("Decimal Places:"))
        self.pie_percent_decimals_spin = QSpinBox()
        self.pie_percent_decimals_spin.setToolTip("Set the number of decimal points for the percentage label")
        self.pie_percent_decimals_spin.setRange(0, 5)
        self.pie_percent_decimals_spin.setValue(2)
        percent_layout.addWidget(self.pie_percent_decimals_spin)

        percent_layout.addWidget(QLabel("Percentage Label Position:"))
        self.pie_percent_label_distance_spin = QDoubleSpinBox()
        self.pie_percent_label_distance_spin.setToolTip(
            "Set the radial distance of the percentage label from the center")
        self.pie_percent_label_distance_spin.setRange(0.0, 2.0)
        self.pie_percent_label_distance_spin.setSingleStep(0.1)
        self.pie_percent_label_distance_spin.setValue(0.6)
        percent_layout.addWidget(self.pie_percent_label_distance_spin)

        percent_layout.addWidget(QLabel("Percentage Font Size:"))
        self.pie_percent_font_size_spin = QSpinBox()
        self.pie_percent_font_size_spin.setToolTip("Set the font size of the percentage label")
        self.pie_percent_font_size_spin.setRange(1, 50)
        self.pie_percent_font_size_spin.setValue(10)
        percent_layout.addWidget(self.pie_percent_font_size_spin)

        percent_layout.addWidget(QLabel("Percentage Label Font Color:"))
        percent_font_color_layout = QHBoxLayout()
        self.pie_percent_label_font_color_button = QPushButton("Choose", parent=self)
        self.pie_percent_label_font_color_button.setToolTip("Select the font color of the percentage label text")
        self.pie_percent_color_label = QLabel("white")
        percent_font_color_layout.addWidget(self.pie_percent_label_font_color_button)
        percent_font_color_layout.addWidget(self.pie_percent_color_label)
        percent_layout.addLayout(percent_font_color_layout)

        pie_layout.addWidget(self.pie_percentage_settings_container)

        def toggle_percent_settings() -> None:
            self.pie_percentage_settings_container.setVisible(self.pie_show_percentages_check.isChecked())

        self.pie_show_percentages_check.stateChanged.connect(toggle_percent_settings)
        toggle_percent_settings()

        pie_layout.addWidget(QLabel("Category Label Position:"))
        self.pie_category_label_distances_spin = QDoubleSpinBox()
        self.pie_category_label_distances_spin.setToolTip(
            "Set the radial distance of the category label from the center")
        self.pie_category_label_distances_spin.setRange(0.0, 2.0)
        self.pie_category_label_distances_spin.setSingleStep(0.1)
        self.pie_category_label_distances_spin.setValue(1.1)
        pie_layout.addWidget(self.pie_category_label_distances_spin)

        pie_layout.addWidget(QLabel("Category Label Font Size:"))
        self.pie_category_label_font_size_spin = QSpinBox()
        self.pie_category_label_font_size_spin.setToolTip("Set the font size of the category labels")
        self.pie_category_label_font_size_spin.setRange(1, 50)
        self.pie_category_label_font_size_spin.setValue(10)
        pie_layout.addWidget(self.pie_category_label_font_size_spin)

        pie_layout.addWidget(QLabel("Category Label Font Color:"))
        category_label_font_color_layout = QHBoxLayout()
        self.pie_category_label_font_color_button = QPushButton("Choose", parent=self)
        self.pie_category_label_font_color_button.setToolTip("Select the font color of the category labels")
        self.pie_category_font_color_label = QLabel("black")
        category_label_font_color_layout.addWidget(self.pie_category_label_font_color_button)
        category_label_font_color_layout.addWidget(self.pie_category_font_color_label)
        pie_layout.addLayout(category_label_font_color_layout)
