...
class ExportDialog(QDialog):
    ...
    def __init__(self, parent: Optional[QWidget] = None, data_handler: Optional[DataHandler] = None, selected_rows: Optional[List[int]] = None, selected_columns: Optional[List[str]]  = None):
    ...
    def _get_checked_columns(self) -> List[str]:
        ...
        return [
            self.column_list.item(i).text() for i in range(self.column_list.count()) if self.column_list.item(i).checkState() == Qt.CheckState.Checked
        ]
